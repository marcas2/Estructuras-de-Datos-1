...
public class Discotienda
{
    ...
    public void generarInformeDiscos() throws FileNotFoundException{
    	...
    	/**
    	 * Crear pluma para escribir archivo
    	 */
    	
    	PrintWriter pluma = new PrintWriter(archivo);
    	
    	/**
    	 * Escribir archivo con la pluma
    	 */
    	...
    	for(int i=0; i<discos.size(); i++) {
        	...
        	/**
        	 * Escribir con pluma la informacion
        	 */
    ...
    /**
     * Metodo generar reporte discos Rock-Pop economicos
     * @throws FileNotFoundException
     * @throws NoHayDiscosException
     */
    
    public void generarDiscosRockPopEconomicos() throws FileNotFoundException, NoHayDiscosException{
    	...
    	pluma.println("Reporte de discos Rock y Pop economicos.");
    	pluma.println("==================");
    	
    	/**
    	 * Variable tipo boolean que analiza si hay datos
    	 */
    	
    	boolean excepcion=false;
    	
    	/*
    	 * Ciclo FOR que recorre cada disco
    	 */
    	...
    	for(int i=0; i<discos.size(); i++) {
        	...
        	/*
        	 * Analizar si el disco cumple con las condiciones
        	 */
        	if( miDisco.darPrecioDisco() < 1000 ) {
            	...
            	pluma.println("Nombre: " + miDisco.darNombreDisco() + 
            			      ...
            			      " Artista" + miDisco.darArtista());
            	/**
            	 * Indicar que si hay datos en el reporte
            	 */
            	excepcion=true;
        		}
        	}
    	 ...
    	 */
     	...
     	/**
     	 * Analizar si se debe mandar la excepcion
     	 */
     	
     	if (!excepcion) {
            throw new NoHayDiscosException("No se encontraron discos que cumplan con los requisitos.");
        }
    ...
    {
    	/*
    	 * Intenta ejecutar el metodo y captura las excepciones generales y la propia
    	 */
    	try {
    	
    		generarDiscosRockPopEconomicos();
        	return "Reporte generado satisfactoriamente";
			
		} 
    	/*
    	 * Catch para capturar la excepcion que creamos y mostrar el mensaje
    	 */
    	catch (NoHayDiscosException e) {
            return "No se encontraron discos que cumplan con los requisitos."; }
    	/**
    	 * Catch que capture todas las excepciones
    	 */
    	catch (Exception e) {
			return "error fatal" + e.getMessage();
		}
     ...
     */
    public class NoHayDiscosException extends Exception {
    	
    	/**
    	 * Metodo constructor
    	 * @param mensaje
    	 */
        public NoHayDiscosException(String mensaje) {
            super();
        }
    }
}
